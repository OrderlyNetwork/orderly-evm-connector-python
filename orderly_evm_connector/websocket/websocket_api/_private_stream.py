...
def get_execution_report(self):
    """Push interval: real-time push
    https://docs-api-evm.orderly.network/#execution-report
    """
    _message = {"id": self.wss_id, "topic": "executionreport", "event": "subscribe"}
    self.send_message_to_server(_message)


def get_execution_report_for_single_broker(self, broker_id: str):
    """Push interval: real-time push
    https://docs-api-evm.orderly.network/#execution-reort-single
    """
    _message = {"id": self.wss_id, "topic": f"executionreport@{broker_id}", "event": "subscribe"}
    self.send_message_to_server(_message)


def get_algo_execution_report(self):
    """Push interval: real-time push
    https://docs-api-evm.orderly.network/#algo-execution-report
    """
