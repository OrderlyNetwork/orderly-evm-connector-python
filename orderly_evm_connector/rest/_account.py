...
def get_registration_nonce(self):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/public/get-registration-nonce
...
def get_account_details(self, account_id: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/public/check-if-account-exists
...
def get_broker(self, address: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/public/check-if-address-is-registered
...
def remove_orderly_key(self, orderly_key: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/public/remove-orderly-key
    """
...
def set_maintenance_config(self, maintenance_cancel_order_flag: bool):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/set-maintenance-config
    """
    check_required_parameters(
...
def get_user_daily_statistics(self, start_date: str, end_date: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-user-daily-statistics
    """
...
def get_user_daily_volume(self, start_date: str, end_date: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-user-daily-volume
    """
    check_required_parameters([[start_date, "start_date"], [end_date, "end_date"]])
    payload = {"start_date": start_date, "end_date": end_date}
...
def get_user_volume_statistics(self):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-user-volume-statistics
    """
...
def get_current_orderlykey_info(self, **kwargs):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-current-orderly-key-info
    """
    payload = {**kwargs}
...
def get_orderlykey_ip_restriction(self, orderly_key: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-orderly-key-ip-restriction
...
def set_orderlykey_ip_restriction(self, orderly_key: str, ip_restriction_list: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/set-orderly-key-ip-restriction
    """
    check_required_parameters(
...
def reset_orderlykey_ip_restriction(self, orderly_key: str, reset_mode: str):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/reset-orderly-key-ip-restriction
    """
    check_required_parameters(
...
def get_all_accounts(self, address: str, broker_id: str, chain_type: str = None):
    ...
    Args:
        address(string): The address of the user wallet
        broker_id(string): The builder that the account is registered on
        
    Optional Args:
        chain_type(string): `EVM` or `SOL`
        
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/public/get-all-accounts
    """
    check_required_parameters([[address, "address"], [broker_id, "broker_id"]])
    payload = {"address": address, "broker_id": broker_id, "chain_type": chain_type}
    return self._request("GET", "/v1/get_all_accounts", payload=payload)


def get_leverage_setting(self, symbol: str):
    ...
    Args:
        symbol(string): Symbol name (e.g., PERP_BTC_USDC)
        
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-leverage-setting
    """
