...
def get_registration_nonce(self):
    ...
    https://docs-api-evm.orderly.network/?shell#restful-api-public-get-registration-nonce
...
def get_account(self, address: str, broker_id: str):
    ...
    https://docs-api-evm.orderly.network/?shell#restful-api-public-get-account
...
def register_account(
    ...
    https://docs-api-evm.orderly.network/#restful-api-public-register-account
    """
    _message = {
        "brokerId": brokerId,
        "chainId": chainId,
...
def get_orderly_key(self, account_id: str, orderly_key: str):
    ...
    https://docs-api-evm.orderly.network/#restful-api-public-get-orderly-key
    """
    check_required_parameters(
...
def add_orderly_key(
    ...
    **kwargs
    ...
    https://docs-api-evm.orderly.network/#restful-api-public-add-orderly-key
    """
    _message = {
        "brokerId": brokerId,
        "chainId": chainId,
...
def update_leverage_configuration(self, leverage: int):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-update-leverage-setting
    """
...
def get_account_information(self):
    ...
    https://docs-api-evm.orderly.network/?shell#restful-api-private-get-account-information
    """
...
def set_maintenance_config(self, maintenance_cancel_order_flag: bool):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-set-maintenance-config
    """
    check_required_parameters(
...
def get_user_daily_volume(self, start_date: str, end_date: str):
    ...
    https://docs-api-evm.orderly.network/?shell#restful-api-private-get-user-daily-volume
    """
    check_required_parameters([[start_date, "start_date"], [end_date, "end_date"]])
    payload = {"start_date": start_date, "end_date": end_date}
...
def get_user_volume_statistics(self):
    ...
    https://docs-api-evm.orderly.network/?shell#restful-api-private-get-user-volume-statistics
    """
...
def get_current_orderlykey_info(self, **kwargs):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-get-current-orderly-key-info
    """
    payload = {**kwargs}
...
def get_orderlykey_ip_restriction(self, orderly_key: str):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-get-orderly-key-ip-restriction
...
def set_orderlykey_ip_restriction(self, orderly_key: str, ip_restriction_list: str):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-set-orderly-key-ip-restriction
    """
    check_required_parameters(
...
def reset_orderlykey_ip_restriction(self, orderly_key: str, reset_mode: str):
    ...
    https://docs-api-evm.orderly.network/#restful-api-private-reset-orderly-key-ip-restriction
    """
    check_required_parameters(
