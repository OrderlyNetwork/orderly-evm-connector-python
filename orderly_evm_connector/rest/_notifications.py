...
def get_all_notifications(self, **kwargs):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-all-notifications
...
def get_unread_notifications(self):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/get-unread-notifications
    """
...
def set_read_status_notifications(self, flag: int, ids: list):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/set-read-status-of-notifications
    """
...
def set_read_status_all_notifications(self, flag: int):
    ...
    https://orderly.network/docs/build-on-omnichain/evm-api/restful-api/private/set-read-status-of-all-notifications
    """
    payload = {"flag": flag}
