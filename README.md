...
cd orderly-evm-connector-python
poetry install 
source /root/.cache/pypoetry/virtualenvs/orderly-evm-connector-isTZpcO3-py3.10/bin/activate
cd examples
python3 examples_api.py
...
request_str = """1649920583000POST/v1/order{"symbol": "PERP_BTC_USDC", "order_type": "LIMIT", "order_price": 44000, "order_quantity": 0.001, "side": "BUY"}"""
